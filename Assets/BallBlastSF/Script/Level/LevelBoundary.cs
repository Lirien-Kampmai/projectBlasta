...
namespace Blasta
{
    public class LevelBoundary : MonoBehaviour
    {
        ...
        public float leftBorder  { get { return Camera.main.ScreenToWorldPoint(new Vector3(0, 0, 0)).x; } }

        public float rightBorder { get { return Camera.main.ScreenToWorldPoint(new Vector3(screenResolution.x, 0, 0)).x; } }
